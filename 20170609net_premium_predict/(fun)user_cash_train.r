...
user_cash_train<-function(trainSetTotal,
                            ...
                            festival_label=c('7f1','7f2','7f3','7f4','7f5',
                                             ...
                                             '3f1','3b1','3b2','3b3',
                                             '2b1','2b2'),
                            trainTimeSpan=c("2016-01-01","2017-06-25"),
  ...
  festivalInfluence<-{
    ...
    x<-as.numeric(!is.na(stl_week_month_linear_detail$Before_Label))+
      as.numeric(!is.na(stl_week_month_linear_detail$Back_Label))+
      as.numeric(!is.na(stl_week_month_linear_detail$In_Label))+1e-7
  ...
  estimate_result<-structure(list(weekly_seasonal = weekly_seasonal,
                                  ...
                                  residuals = stl_week_month_linear_unfeast_detail$unfeast_residuals,
